"""
Scraper for Montana DOT contracting.
"""
...
class MontanaDOTScraper(BaseScraper):
    """
    Scraper for Montana Department of Transportation website.
    """
    
    def __init__(self):
        super().__init__(
            source_name="Montana DOT",
            base_url="https://www.mdt.mt.gov"
        )
        self.projects_url = "https://www.mdt.mt.gov/business/contracting"
    
    def scrape(self) -> List[Dict[str, Any]]:
        """
        Scrape Montana DOT website for project listings.
        ...
        try:
            ...
            print(f"Error scraping Montana DOT: {e}")
