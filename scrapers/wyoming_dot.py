"""
Scraper for Wyoming DOT contractor opportunities.
"""
...
class WyomingDOTScraper(BaseScraper):
    """
    Scraper for Wyoming Department of Transportation website.
    """
    
    def __init__(self):
        super().__init__(
            source_name="Wyoming DOT",
            base_url="https://www.dot.state.wy.us"
        )
        self.projects_url = "https://www.dot.state.wy.us/business/contracting"
    
    def scrape(self) -> List[Dict[str, Any]]:
        """
        Scrape Wyoming DOT website for project listings.
        ...
        try:
            ...
            print(f"Error scraping Wyoming DOT: {e}")
