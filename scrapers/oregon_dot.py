"""
Scraper for Oregon DOT procurement.
"""
...
class OregonDOTScraper(BaseScraper):
    """
    Scraper for Oregon Department of Transportation website.
    """
    
    def __init__(self):
        super().__init__(
            source_name="Oregon DOT",
            base_url="https://www.oregon.gov/odot"
        )
        self.projects_url = "https://www.oregon.gov/odot/business/Pages/contracting.aspx"
    
    def scrape(self) -> List[Dict[str, Any]]:
        """
        Scrape Oregon DOT website for project listings.
        ...
        try:
            ...
            print(f"Error scraping Oregon DOT: {e}")
        return projects
